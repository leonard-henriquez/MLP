...
public:
    ...
    void setStructure (const vector<integer> &str, const initialise &init = INIT, const resetOrNot &override = RESET);
    ...
    void gradientDescentIter (learningParameters &parameters);
